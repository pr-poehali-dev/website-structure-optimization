          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-base md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                ...
                Место встречи экспертов для обмена опытом и обсуждения будущего психотерапии.
              </p>
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="space-y-6">
                ...
                <CardHeader>
                  ...
                  <CardDescription className="text-base">
                    <div className="space-y-3 mt-4">
                      ...
                      <p className="mt-2 ml-4">• Сильвия Паглизи, президент Латиноамериканской ассоциации Роршаха и проективных методик (ALAR); член Совета директоров Испанской федерации ассоциаций психотерапевтов (FEAP)</p>
                      <p className="mt-2 ml-4">• Лорена Фернандез, Директор Учебного и Научно-исследовательского института имени Фредерика Перлза в гештальт-психотерапии. Мексика</p>
              ...
              <Card className="border-l-4 border-l-[#763349] bg-[#763349]/5">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <Badge className="bg-[#763349]">12:00 – 12:40</Badge>
              ...
              <Card className="border-l-4 border-l-[#763349]">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <Badge className="bg-[#763349]">12:40 – 13:00</Badge>
              ...
              <Card className="border-l-4 border-l-[#763349]">
                <CardHeader>
                  <div className="flex items-center gap-3 mb-2">
                    <Badge className="bg-[#763349]">16:35 – 17:00</Badge>
                    <CardTitle className="text-xl">Видеообращения</CardTitle>
                  </div>
                </CardHeader>
              </Card>
